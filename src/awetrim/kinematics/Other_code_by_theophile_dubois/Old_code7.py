import numpy as np
import casadi as ca
import awetrim.kinematics.Other_code_by_theophile_dubois.my_RI_fitting as ribfit
from awetrim.kinematics.Other_code_by_theophile_dubois.my_reelin_parametrization import ParametrizedPatternsAngles
