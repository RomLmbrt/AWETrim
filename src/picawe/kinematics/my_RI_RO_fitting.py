...
class RI_RO_fitting(RI_RO_data_processing, ReelInBspline_build):
    ...
    def fit_RI_RO(self, mode="spherical"):
        ...
        def residuals(params):
            ...
            # For now I ignore res_extra because I need to recompute the crs and velocity at the start and end of RI_RO segment and I am too lazy
...
if __name__ == "__main__":
    ...
    obj = RI_RO_fitting(file_path_full=full_path, file_path_cycle=cycle_path, cyc_idx=0, p=3, n_ctrl=6,
                 c_penalty=0.0, v_penalty=0.0, eps_knot=1e-3)
