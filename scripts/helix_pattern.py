...
CYCLE_CONFIG_PATH = Path(
    "results/optimized_configs/helix/depower_helix_optimized_config_wind_18_z0_0.03_logarithmic.yaml"
)

# Load configurations from YAML
REELOUT_CONFIG, REELIN_CONFIG = load_cycle_config_from_yaml(CYCLE_CONFIG_PATH)
# REELOUT_CONFIG["path_parameters"]["beta0"] += -0.1
# REELOUT_CONFIG["path_parameters"]["r0"] =
# REELOUT_CONFIG["path_parameters"]["kappa"] = 1
REELOUT_CONFIG["path_parameters"]["kbeta"] = 0
REELOUT_CONFIG["sim_parameters"]["input_depower"] += 0.6

WIND_CONFIG = {
    "speed_wind_at_200": 20,
    "z0": 0.03,
...
def main(run_plots=False):
    ...
    filename = f"{depower_prefix}helix_optimized_config_wind_{WIND_CONFIG['speed_wind_at_200']}_z0_{WIND_CONFIG['z0']}_{WIND_CONFIG['model_type']}.yaml"
