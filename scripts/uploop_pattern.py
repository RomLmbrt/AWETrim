...
CYCLE_CONFIG_PATH = Path(
    "results/optimized_configs/uploops/depower_uploop_optimized_config_wind_20_z0_0.03_logarithmic.yaml"
)

# Load configurations from YAML
REELOUT_CONFIG, REELIN_CONFIG = load_cycle_config_from_yaml(CYCLE_CONFIG_PATH)
# REELOUT_CONFIG["path_parameters"]["beta0"] = 0.5
REELOUT_CONFIG["path_parameters"]["kappa"] = 1
# REELOUT_CONFIG["path_parameters"]["az_amp0"] += 0.2
# REELOUT_CONFIG["path_parameters"]["beta_amp0"] += 0.1
# REELOUT_CONFIG["sim_parameters"]["input_depower"] += 0.35
WIND_CONFIG = {
    "speed_wind_at_200": 19,
    "z0": 0.03,
...
def build_wind_model(speed_wind_at_200=8, z0=0.01, model_type="uniform"):
    ...
    speed_friction = 0.41 * speed_wind_at_200 / np.log(100 / wind_model.z0)
...
def main(run_plots=False):
    ...
    filename = f"{depower_prefix}uploop_optimized_config_wind_{WIND_CONFIG['speed_wind_at_200']}_z0_{WIND_CONFIG['z0']}_{WIND_CONFIG['model_type']}.yaml"
