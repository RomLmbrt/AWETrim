...
def main():
    ...
    for phase_idx in range(len(winch_depower_data)):
        ...
        init_condit_dict.append({
            "t": states["quasi_steady"][-1]["t"],
            "s": states["quasi_steady"][-1]["s"],
            "s_dot": states["quasi_steady"][-1]["s_dot"],
            "s_ddot": states["quasi_steady"][-1]["s_ddot"] if states["quasi_steady"][-1]["s_ddot"] is not None else 0,
            "input_steering": states["quasi_steady"][-1]["input_steering"],
            "tension_tether_ground": states["quasi_steady"][-1]["tension_tether_ground"],
            "input_depower": states["quasi_steady"][-1]["input_depower"] if states["quasi_steady"][-1]["input_depower"] is not None else 0.4,
            "speed_radial": states["quasi_steady"][-1]["speed_radial"],
    ...
    return init_condit_dict[-1] # Return the last state as initial condition for further use in the reelout_Lissajous segment

init_conditions = main()